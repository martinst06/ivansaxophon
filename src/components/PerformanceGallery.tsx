...
const PerformanceGallery = ({ lang }: PerformanceGalleryProps) => {
  ...
  return (
    <section id="gallery" className="py-16 sm:py-20 bg-gradient-to-br from-charcoal via-charcoal to-charcoal/95">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {galleryItems.map((item, index) => (
            ...
            >
              {/* Image placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-bronze-light/30 via-beige/20 to-bronze/30 relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white/60">
                    ...
                    <p className="text-xs sm:text-sm font-medium">{item.category}</p>
                  </div>
                </div>
              ...
              {/* Category badge */}
              <div className="absolute top-4 right-4 bg-bronze/90 text-white px-2 py-1 rounded-full text-xs font-medium">
                {item.category}
              </div>
            </div>
          ))}
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 sm:p-12">
            ...
            <div className="flex justify-center space-x-4 sm:space-x-6">
              <a 
                ...
                className="text-bronze hover:text-bronze-dark transition-colors duration-300 p-3 rounded-full hover:bg-bronze/10 min-h-[44px] min-w-[44px] flex items-center justify-center"
